...
;layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    M.prototype.config = {
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            var c = {};
            var serviceDate = new Date(t.ajax({async: false}).getResponseHeader("Date")).getTime();
        ...
        if (t.loading && t.url) return l.msg(lan == 2 ? "data request" : "数据请求中", {
            icon: 16,
